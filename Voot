...
*****************************************************
              📺 VOOT Streamer 😉
⚒ It can Stream The VOOT Movies , TV SHows and Series All content
...
key = input(' Enter Voot Link :')

url = 'https://vootapi.tk/?q=%s' % (key)

response = reqs.get('https://vootapi.tk/?q==%s' % (key))
